...
public class RepairHttpServlet {
    ...
    public static void getBase64(String base64, OkhttpData okhttpData) {
        ...
        ThreadFactory threadFactory = new CartoonHttpServlet.CustomThreadFactory("Base64Thread");
        ...
        threadPool.execute(() -> {
            ...
            Request request = new Request.Builder().url(HttpUtil.REPAIR).post(requestBody).header("Content-Encoding", "gzip").removeHeader("User-Agent").build();
            ...
            call.enqueue(new Callback() {
                ...
                public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                    ...
                    try {
                        ...
                        String json = jsonObject.getString("enhanced_image");
