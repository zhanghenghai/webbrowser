...
public class VisaDao {
    ...
    private VisaDBHelper dbHelper;

    public VisaDao(Context context) {
        dbHelper = new VisaDBHelper(context);
    }
    ...
    public void inserData(Resource resource) {
        ...
        try {
            ...
            db.replaceOrThrow(VisaDBHelper.TABLE_NAME, null, contentValues);
